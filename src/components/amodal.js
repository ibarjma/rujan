...
const Amodal = ({ fondo, delante, list, title, tick, id }) => {
  return (
    <div className='relative px-3 mt-16 max-w-screen-md lg:max-w-6xl md:max-w-5xl sm:mx-auto pb-8'>
      <div className='cuadradoDesfazado h-full w-full sm:w-full relative bottom-2'>
        <div
